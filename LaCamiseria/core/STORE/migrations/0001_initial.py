    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'db_table': 'Categias',
                'ordering': ['nombre'],
                'indexes': [models.Index(fields=['nombre'], name='Categias_nombre_24c055_idx')],
            },
        ),
        migrations.CreateModel(
            name='Noticia',
        ...
        migrations.AddIndex(
            model_name='producto',
            index=models.Index(fields=['id', 'slug'], name='Productos_id_058f29_idx'),
        ),
        migrations.AddIndex(
            model_name='producto',
            index=models.Index(fields=['nombre'], name='Productos_nombre_e60d36_idx'),
        ),
        migrations.AddIndex(
            model_name='producto',
            index=models.Index(fields=['-created'], name='Productos_created_30d88e_idx'),
        ),
    ]
