...
class Producto(models.Model):
    ...
    nombre = models.CharField(max_length=200, unique=True, verbose_name='Nombre')
    slug = models.SlugField(max_length=200, unique=True, verbose_name='Slug')
    imagen = models.ImageField(upload_to='productos/img/%Y/%m/%d', default='img/product_default.png',
                               verbose_name='Imagen')
    ...
    def get_absolute_url(self):
        return reverse('store:productoDetail', args=[str(self.id)])
...
class GaleriaProductos(models.Model):
    producto = models.ForeignKey(Producto, on_delete=models.CASCADE, default=None, related_name='imagenes',
                                 verbose_name='Producto')
    imagen = models.ImageField(upload_to='productos/galeria/img/%Y/%m/%d', blank=True, null=True,
                               verbose_name='Imagen')
    ...
    class Meta:
        db_table = 'GaleriaProductos'
        verbose_name = 'GaleriaProductos'
        verbose_name_plural = 'GaleriaProductos'
        ordering = ['producto']
