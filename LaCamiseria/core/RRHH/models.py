...
class Empleado(models.Model):
    ...
    #user = models.ForeignKey(User, on_delete=models.CASCADE,limit_choices_to={'group__name': 'empleados'} , verbose_name="Empleado")
    puestoTrabajo = models.ForeignKey(PuestoTrabajo, on_delete=models.SET_NULL,blank=True,null=True, verbose_name="Puesto")
