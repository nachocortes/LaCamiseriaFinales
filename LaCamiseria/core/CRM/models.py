...
from core.CRM.choices import tipo_documento_choices, tipo_cliente_choices, tipo_direccion_choices, tipo_via_choices
from core.RRHH.models import Empleado


class Cliente(models.Model):
    nombre = models.CharField(max_length=200, verbose_name="Nombre del Cliente")
    user = models.ForeignKey(User, on_delete=models.CASCADE, related_name='clientes_registro', null=True, blank=True, verbose_name="Cliente")
    tipoDocumento = models.CharField(max_length=20, null=True, verbose_name="Tipo de Documento", choices=tipo_documento_choices)
    documento = models.CharField(max_length=60, verbose_name="Documento del Cliente")
    comercial = models.ForeignKey(Empleado, on_delete=models.SET_NULL, null=True, blank=True, verbose_name="Comercial Asignado")
    password = models.CharField(max_length=50, verbose_name="Contraseña del Cliente")
    email = models.EmailField(blank=True, null=True, verbose_name="Email")
    telefono = models.CharField(max_length=20, blank=True, null=True, verbose_name="Teléfono")
    tipoCliente = models.CharField(max_length=200, blank=True, verbose_name="Tipo de Cliente", choices=tipo_cliente_choices)
